...
CREATE TABLE pay_demo_order (
                                ...
                                price int4 NOT NULL,
                                pay_status bool NOT NULL DEFAULT '0',
...
CREATE SEQUENCE pay_demo_order_seq
    START 1;
...
CREATE TABLE pay_demo_transfer (
                                   ...
                                   alipay_logon_id varchar(64) NULL DEFAULT NULL,
                                   openid varchar(64) NULL DEFAULT NULL,
                                   transfer_status int2 NOT NULL DEFAULT 0,
...
ALTER TABLE pay_demo_transfer ADD CONSTRAINT pk_pay_demo_transfer PRIMARY KEY (id);

COMMENT ON COLUMN pay_demo_transfer.id IS '订单编号';
COMMENT ON COLUMN pay_demo_transfer.app_id IS '应用编号';
COMMENT ON COLUMN pay_demo_transfer.type IS '转账类型';
COMMENT ON COLUMN pay_demo_transfer.price IS '转账金额，单位：分';
COMMENT ON COLUMN pay_demo_transfer.user_name IS '收款人姓名';
COMMENT ON COLUMN pay_demo_transfer.alipay_logon_id IS '支付宝登录号';
COMMENT ON COLUMN pay_demo_transfer.openid IS '微信 openId';
COMMENT ON COLUMN pay_demo_transfer.transfer_status IS '转账状态';
COMMENT ON COLUMN pay_demo_transfer.pay_transfer_id IS '转账订单编号';
COMMENT ON COLUMN pay_demo_transfer.pay_channel_code IS '转账支付成功渠道';
COMMENT ON COLUMN pay_demo_transfer.transfer_time IS '转账支付时间';
COMMENT ON COLUMN pay_demo_transfer.creator IS '创建者';
COMMENT ON COLUMN pay_demo_transfer.create_time IS '创建时间';
COMMENT ON COLUMN pay_demo_transfer.updater IS '更新者';
COMMENT ON COLUMN pay_demo_transfer.update_time IS '更新时间';
COMMENT ON COLUMN pay_demo_transfer.deleted IS '是否删除';
COMMENT ON COLUMN pay_demo_transfer.tenant_id IS '租户编号';
COMMENT ON TABLE pay_demo_transfer IS '示例业务转账订单';

DROP SEQUENCE IF EXISTS pay_demo_transfer_seq;
CREATE SEQUENCE pay_demo_transfer_seq
    START 1;
...
COMMENT ON COLUMN pay_notify_task.merchant_transfer_id IS '商户转账单编号';
...
CREATE TABLE pay_order (
                           ...
                           notify_url varchar(1024) NOT NULL,
                           price int8 NOT NULL,
                           channel_fee_rate decimal(9,4) NULL DEFAULT 0,
...
CREATE TABLE pay_order_extension (
                                     ...
                                     user_ip varchar(50) NOT NULL,
                                     status int2 NOT NULL,
                                     channel_extras varchar(256) NULL DEFAULT NULL,
...
COMMENT ON COLUMN pay_transfer.type IS '类型';
...
COMMENT ON COLUMN pay_transfer.alipay_logon_id IS '支付宝登录号';
COMMENT ON COLUMN pay_transfer.openid IS '微信 openId';
...
CREATE SEQUENCE pay_transfer_seq
    START 1;
...
CREATE SEQUENCE pay_wallet_seq
    START 1;
...
CREATE SEQUENCE pay_wallet_recharge_seq
    START 1;
...
CREATE SEQUENCE pay_wallet_recharge_package_seq
    START 1;
...
CREATE SEQUENCE pay_wallet_transaction_seq
    START 1;
